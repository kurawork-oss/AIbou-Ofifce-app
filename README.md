...
| モード | 内容 |
|---|---|
| 🏢 **オフィス** | **3Dオフィス**(トイ調・高解像度レンダリング):ロボットAI社員(個性: アンテナ・目の色・デカール・耳ポッド・身長)がエントランスから出社し、**通路や会議室のドアを通って歩いて移動**する。ロボット/デスク/部署ホワイトボード/共有キャビネット/会議室モニターを**クリックすると詳細パネル**(成果物・目標進捗・議事録)が開く |
