...
| モード | 内容 |
|---|---|
| 🏢 **オフィス** | **3Dオフィス**:ロボットAI社員(個性: アンテナ・目の色・デカール・耳ポッド・身長)が働く海外風オフィス。**俯瞰ビュー**と**ウォークモード(FPS: WASD移動+マウス視点)** を切替可。ロボット/デスク/部署ホワイトボード/共有キャビネット/会議室モニターを**クリックすると詳細パネル**(成果物・目標進捗・議事録)が開く |
